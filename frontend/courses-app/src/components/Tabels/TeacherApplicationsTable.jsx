      ...
      <table className="min-w-full bg-white border rounded-lg shadow-lg">
        <thead className="bg-gray-800 text-white">
          <tr>
            ...
            <th className="w-1/5 py-3 px-4 border-b text-sm font-semibold text-center">Date</th>
        ...
        <tbody className="text-gray-700 font-semibold text-center">
          {applications.map((app) => (
            <tr key={app._id} className="hover:bg-gray-100 transition-colors duration-200">
              ...
              <td className="py-3 px-4 border-b text-center">{new Date(app.appliedOn).toLocaleDateString('en-GB')}</td>
